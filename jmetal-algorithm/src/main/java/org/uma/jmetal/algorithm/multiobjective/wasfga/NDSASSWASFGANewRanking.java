...
import org.uma.jmetal.algorithm.multiobjective.wasfga.util.NewWASFGARanking;
 ...
 *         
 */
public class NDSASSWASFGANewRanking<S extends Solution<?>> extends AbstractMOMBI<S> {
	/**
	 *
	 */
	 ...
	 *            Problem to solve
	 */
	public NDSASSWASFGANewRanking(Problem<S> problem,
								int populationSize,
								int maxIterations,
...
//		}
	...
	protected Ranking<S> computeRanking(List<S> solutionList) {
		...
		Ranking<S> ranking = new NewWASFGARanking<>(this.achievementScalarizingFunction);
