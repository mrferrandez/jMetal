...
public class SMSEMOA_ROI<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
   ...
   * Constructor
   */
  public SMSEMOA_ROI(Problem<S> problem, int maxEvaluations, int populationSize, double offset,
