...
import org.uma.jmetal.algorithm.multiobjective.wasfga.util.WASFGARankingND;
 ...
 */
public class NDrankWASFGA<S extends Solution<?>> extends WASFGA<S> {
	/**
	 *
	 */
...
//	List<Double> referencePoint = null;
	 ...
	 *            Problem to solve
	 */
	public NDrankWASFGA(Problem<S> problem,
								int populationSize,
								int maxIterations,
...
//	    .print();
	...
	protected Ranking<S> computeRanking(List<S> solutionList) {
		...
		Ranking<S> ranking = new WASFGARankingND<>(this.achievementScalarizingFunction);
	...
	@Override public String getName() {
		return "WASFGA with ND Ranking" ;
	}

	@Override public String getDescription() {
		return "ND Ranking Weighting Achievement Scalarizing Function Genetic Algorithm" ;
	}
}
