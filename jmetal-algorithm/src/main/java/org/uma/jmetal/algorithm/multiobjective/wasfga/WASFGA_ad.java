 ...
 *         
 */
public class WASFGA_ad<S extends Solution<?>> extends WASFGA<S> {
	/**
	 *
	 */
...
//  final ASFWASFGA<S> achievementScalarizingFunction; // La hereda de WASFGA
//  List<Double> referencePoint = null; // Lo hereda de WASFGA
	 ...
	 *            Problem to solve
	 */
	public WASFGA_ad(Problem<S> problem,
								int populationSize,
								int maxIterations,
...
//		}
	...
	@Override public String getDescription() {
		return "Weighting Achievement Scalarizing Function Genetic Algorithm Advanced Population" ;
	}
}
