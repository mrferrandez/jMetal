...
import org.uma.jmetal.algorithm.multiobjective.wasfga.NDSWASFGA;
...
public class NDSWASFGARunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new NDSWASFGA<DoubleSolution>(problem, 30, 10, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((NDSWASFGA<DoubleSolution>) algorithm).getAllPopulation() ;
