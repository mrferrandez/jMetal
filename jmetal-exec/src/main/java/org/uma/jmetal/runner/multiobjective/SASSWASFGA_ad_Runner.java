...
import org.uma.jmetal.algorithm.multiobjective.wasfga.SASSWASFGA_ad;
...
public class SASSWASFGA_ad_Runner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new SASSWASFGA_ad<DoubleSolution>(problem, 30, 15, localSearch, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((SASSWASFGA_ad<DoubleSolution>) algorithm).getAllPopulation() ;
