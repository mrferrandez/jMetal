...
import org.uma.jmetal.algorithm.multiobjective.wasfga.NDSASSWASFGA;
import org.uma.jmetal.algorithm.multiobjective.wasfga.NDSASSWASFGANewRanking;
...
public class NDSASSWASFGARunnerNewR extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new NDSASSWASFGANewRanking<DoubleSolution>(problem, 30, 10, localSearch, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((NDSASSWASFGA<DoubleSolution>) algorithm).getAllPopulation() ;
