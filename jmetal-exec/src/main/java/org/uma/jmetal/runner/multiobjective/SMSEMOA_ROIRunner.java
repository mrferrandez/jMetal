...
import org.uma.jmetal.algorithm.multiobjective.smsemoa.SMSEMOA_ROI;
 ...
 */
public class SMSEMOA_ROIRunner extends AbstractAlgorithmRunner {
  /**
...
//  }
    ...
    algorithm = new SMSEMOA_ROI<DoubleSolution>(problem, 6600, 200, 100.0, crossover, mutation, selection, hypervolume);
//    		SMSEMOABuilder<DoubleSolution>(problem, crossover, mutation)
