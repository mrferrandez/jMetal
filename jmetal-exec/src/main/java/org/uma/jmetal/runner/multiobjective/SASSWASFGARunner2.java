...
public class SASSWASFGARunner2 extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new SASSWASFGA<DoubleSolution,List<DoubleSolution>>(problem, 1, 3, localSearch,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
