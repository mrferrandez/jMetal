...
import org.uma.jmetal.algorithm.multiobjective.wasfga.PAR_SASS;
...
public class PAR_SASSRunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new PAR_SASS<DoubleSolution>(problem, 50, 100, localSearch, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((PAR_SASS<DoubleSolution>) algorithm).getAllPopulation() ;
