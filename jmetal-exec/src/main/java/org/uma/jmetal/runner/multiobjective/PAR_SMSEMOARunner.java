...
import org.uma.jmetal.algorithm.multiobjective.smsemoa.PAR_SMSEMOA;
 ...
 */
public class PAR_SMSEMOARunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new PAR_SMSEMOA<DoubleSolution>(problem, 1000, 5, 100.0, crossover, mutation, selection, hypervolume, referencePoint);
