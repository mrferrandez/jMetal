...
import org.uma.jmetal.algorithm.multiobjective.wasfga.WASFGA_ad_OBL;
...
public class WASFGA_ad_OBLRunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new WASFGA_ad_OBL<DoubleSolution>(problem, 30, 15, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((WASFGA_ad_OBL<DoubleSolution>) algorithm).getAllPopulation() ;
