...
import org.uma.jmetal.algorithm.multiobjective.wasfga.WASFGANewRanking;
...
public class WASFGANewRankingRunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new WASFGANewRanking<DoubleSolution>(problem, 10, 30, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((WASFGANewRanking<DoubleSolution>) algorithm).getAllPopulation() ;
