...
public class NonDominatedRunner {
	...
	public static <S extends Solution<?>> void main(String[] args) throws FileNotFoundException{
		...
		new SolutionListOutput(nondominatedList)
	    .setSeparator("\t")
	    .setVarFileOutputContext(new DefaultFileOutputContext("VARnd.tsv"))
	    .setFunFileOutputContext(new DefaultFileOutputContext("FUNnd.tsv"))
	    .print();
	}
