...
import org.uma.jmetal.algorithm.multiobjective.wasfga.WASFGA_ad;
...
public class WASFGA_ad_Runner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    algorithm = new WASFGA_ad<DoubleSolution>(problem, 50, 250, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
    ...
    List<DoubleSolution> allpopulation = ((WASFGA_ad<DoubleSolution>) algorithm).getAllPopulation() ;
