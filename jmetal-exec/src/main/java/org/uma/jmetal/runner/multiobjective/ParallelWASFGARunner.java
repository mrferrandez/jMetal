...
public class ParallelWASFGARunner extends AbstractAlgorithmRunner {
  /**
...
//    }
    ...
    problemName ="org.uma.jmetal.problem.multiobjective.zdt.ZDT1"; // BacVitTemp";
    ...
    SolutionListEvaluator<DoubleSolution> evaluator = new MultithreadedSolutionListEvaluator<DoubleSolution>(2, problem) ;
    algorithm = new WASFGA<DoubleSolution>(problem, 20, 20, crossover, mutation, selection, evaluator,referencePoint) ;
