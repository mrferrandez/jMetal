...
//    }
    ...
    algorithm = new WASFGAConstr<DoubleSolution>(problem, 200, 33, crossover, mutation, selection,new SequentialSolutionListEvaluator<DoubleSolution>(),referencePoint) ;
